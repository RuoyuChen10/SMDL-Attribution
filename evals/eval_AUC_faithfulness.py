...
def parse_args():
    ...
    parser.add_argument('--explanation-dir', 
                        type=str, 
                        default='submodular_results/ablation-imagebind-score-function/slico-0.0-0.05-10.0-0.0-pending-samples-8',
...
def main(args):
    ...
    for class_id in tqdm(class_ids):
        ...
        for json_file_name in json_file_names:
            ...
            deletion_score = 1 - np.array([insertion_score[-1]] + deletion_score)
