...
def parse_args():
    parser = argparse.ArgumentParser(description='Deletion and Insertion Metric for Other Methods')
    # general
    ...
    parser.add_argument('--explanation-method', 
                        type=str, 
                        default='./explanation_results/imagenet-imagebind-true/HsicAttributionMethod/npy',
...
def main(args):
    ...
    # original
    insertion_metric = Insertion(model, input_image, label_onehot, batch_size=512)

    mufidelity_score_org = metric(explanations)
    
    print("Original Attribution Method Insertion Score: {}".format(mufidelity_score_org))
    print("Our Method Insertion Score: {}".format(mufidelity_score))
    return 
