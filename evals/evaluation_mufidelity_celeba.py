...
def parse_args():
    ...
    parser.add_argument('--explanation-smdl', 
                        type=str, 
                        default='./submodular_results/celeba/superpixel-seeds-1.0-1.0-3.0-1.0/npy',
...
def main(args):
    ...
    metric = MuFidelity(model, input_image, label_onehot, nb_samples=32)
    ...
    print("Celeb-A Dataset MuFidelity Score")
