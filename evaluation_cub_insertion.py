...
def parse_args():
    ...
    parser.add_argument('--explanation-smdl', 
                        ...
                        # default='./submodular_results/cub/grad-10x10-4/HsicAttributionMethod-8x8-24-1.0-1.0-0.0-1.0/npy',
...
def convert_smdl_mask(smdl_mask):
    ...
    for smdl_single_mask in smdl_mask:
        ...
        single_mask = cv2.resize(single_mask.astype(np.uint8), (14,14))    # for smooth
