...
def parse_args():
    ...
    parser.add_argument('--explanation-smdl', 
                        ...
                        # default='./submodular_results/vggface2/grad-10x10-4/HsicAttributionMethod-7x7-24-1.0-100.0-1.0-1.0/npy',
                        # default='./submodular_results/celeba/random_patch-7x7-48/npy',
                        # default='./submodular_results/celeba/random_patch-14x14-195/npy',
...
def convert_smdl_mask(smdl_mask):
    ...
    for smdl_single_mask in smdl_mask:
        ...
        single_mask = cv2.resize(single_mask, (28,28))  # for smooth
